...
const ContactFormSchema = Yup.object().shape({
  ...
  emailProfessionnel: Yup.string().email("Invalid email"),
    ...
    >
      {({ setFieldValue }) => (
        <Form className="form-custom-style">
          ...
          {/* Service */}
          <FormGroup className="form-group">
            <label htmlFor="service" className="label-inline">
              Service
            </label>
          ...
          <FormGroup className="form-group">
            <label htmlFor="emailProfessionnel" className="label-inline">
              Email professionnel
            </label>
            <Field
              ...
              className="input-mask"
            />
            <ErrorMessage name="emailProfessionnel" component="div" />
          </FormGroup>
          ...
          <FormGroup className="form-group">
            ...
            <Field name="motDePasse2" type="password" className="input-mask" />
